...
if not defined PyDir @set "PyDir=C:\Python38"
if not defined PyVerMajor @set "PyVerMajor=3"
if not defined PyVerMinor @set "PyVerMinor=8"
...
:: Get the Architecture by detecting the Program Files (x86) directory
Set "Arch=x86"
...
If Exist "%BinDir%\" (
    @echo %~nx0 :: Removing %BinDir%
    @echo ----------------------------------------------------------------------
    rd /S /Q "%BinDir%"
)

:: Copy the contents of the Python Dir to bin
@echo %~nx0 :: Copying "%PyDir%" to bin...
@echo ----------------------------------------------------------------------
...
@echo %~nx0 :: Copying configs to buildenv\conf...
@echo ----------------------------------------------------------------------
...
:dependencies_x86
@echo.
@echo %~nx0 :: Copying VCRedist 2013 X86 to Prerequisites
@echo ----------------------------------------------------------------------
...
:dependencies_x64
@echo.
@echo %~nx0 :: Copying VCRedist 2013 X64 to Prerequisites
@echo ----------------------------------------------------------------------
...
@echo %~nx0 :: Removing fixed path from .exe files
@echo ----------------------------------------------------------------------
...
@echo %~nx0 :: Cleaning up unused files and directories...
@echo ----------------------------------------------------------------------
...
@echo %~nx0 :: Building the installer...
@echo ----------------------------------------------------------------------
